...
import cool.generator.MIPSCodeGenVisitor;
import cool.semantics.ASTDefinitionPassVisitor;
import cool.semantics.ASTResolutionPassVisitor;
import org.antlr.v4.runtime.*;
import org.antlr.v4.runtime.tree.*;

import cool.lexer.*;
import cool.parser.*;
import cool.semantics.structures.SymbolTable;
...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var code = ast.accept(new MIPSCodeGenVisitor());
        System.out.println(code.template.render());
    }
}
