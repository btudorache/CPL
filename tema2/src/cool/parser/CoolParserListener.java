...
public interface CoolParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code initcall}
	 * labeled alternative in {@link CoolParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterInitcall(CoolParser.InitcallContext ctx);
	/**
	 * Exit a parse tree produced by the {@code initcall}
	 * labeled alternative in {@link CoolParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitInitcall(CoolParser.InitcallContext ctx);
	/**
